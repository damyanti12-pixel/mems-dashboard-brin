...
<div style="display:flex;align-items:center;gap:14px;">
  ...
  <div>
    <div class="title-big">M-EMS</div>
    <div class="subtitle">Marine Engine Monitoring System</div>
  </div>
</div>
""", unsafe_allow_html=True)
...
try:
    ...
    # ambil 500 data terakhir dari sheet
    df = df.iloc[-500:].copy()
    # urutkan supaya grafik rapi
...
# >>> FIX 1: buang baris rusak (grafik bersih)
df = df.dropna(subset=["waktu", "suhu", "getaran"])
...
if menu == "Home":
    ...
    with c1:
    	st.image("alat_mems.jpg", width=280)
...
# ================= IOT MONITOR =================
    ...
    a.plotly_chart(go.Figure(go.Indicator(
        ...
        gauge={"axis":{"range":[0,120]},
               "steps":[
                   {"range":[0,100],"color":"#15803d"},
                   {"range":[100,110],"color":"#f59e0b"},
                   {"range":[110,120],"color":"#dc2626"}
               ]}
...
# ================= README =================
    ...
    with t4:
        ...
        <div class="card">
        <b>KONDISI AMAN</b><br>
        Suhu 70–100°C, Getaran &lt; 1.2, Oil = ON<br><br>

        <b>KONDISI WASPADA</b><br>
        Suhu 100–110°C atau Getaran 1.2–2.0<br><br>

        <b>KONDISI BAHAYA</b><br>
        Suhu &gt; 110°C, Getaran ≥ 2.0, Oil OFF
        </div>
        """, unsafe_allow_html=True)
